# Hi ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif) I'm Mohamed Yassine Khales

### M2 MVA (ENS Paris-Saclay) & Télécom Paris Student | Aspiring AI Researcher

I am an engineering and applied mathematics student aspiring to become an AI researcher. Driven by a deep curiosity for the mathematical foundations of artificial intelligence, my goal is to understand, critique, and innovate upon the theoretical mechanics that govern modern learning algorithms. 
...
### 🔬 Research Interests
*   **Computer Vision:** Representation learning, Biomedical imaging, HR imaging, Generative Models, 3D Vision.
*   **Deep Learning Theory:** Mathematical foundations of neural architectures, Optimization.
*   **Reinforcement Learning:** Stability of RL algorithms, Agent-based AI.
*   **Signal Processing:** Time Series, Sound and Music processing.
...
- **EHL Hackathon (TUM.ai) | 1st Track Winner**  
  Leveraged the *House Diffusion* model to procedurally generate detailed room configurations based on raw apartment layouts. Won the primary track prize by designing and deploying a robust generative AI pipeline.

- **GenHack 4 (École Polytechnique) | Climate Tech & AI**  
  Developed generative models to reconcile urban temperature anomalies, correcting complex discrepancies between ERA5-LAND estimations and ground-truth data. Ranked in the Top 3 across several evaluation tracks during this 4-week intensive data science competition.
...
<p align="left"> 
  <a href="https://www.github.com/Mohamedyk10" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/socials/github.svg" width="32" height="32" alt="GitHub" title="GitHub" /> </a> 
  <a href="https://www.linkedin.com/in/mohamed-yassine-khales/" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/socials/linkedin.svg" width="32" height="32" alt="LinkedIn" title="LinkedIn" /> </a>
</p>
